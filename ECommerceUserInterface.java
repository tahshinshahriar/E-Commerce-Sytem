...
public class ECommerceUserInterface extends ExceptionHandler
{
    public static void main(String[] args) throws IOException {
        ...
        while (scanner.hasNextLine())
        {
            try {
                ...
                } else if (action.equalsIgnoreCase("NEWCUST"))    // Create a new  customer
                {
                    String name = "";
                    String address = "";
                ...
                } else if (action.equalsIgnoreCase("SORTCUSTS")) // sort products by name (alphabetic)
                {
                    ...
                    amazon.printStats();
                } else if (action.equalsIgnoreCase("ADDTOCART")) //add products to the cart
                {
                    String productId = "";
                    String customerId = "";
                    ...
                    //Size and Colour selection for shoe products
                    System.out.print("\nPRESS ENTER TO SKIP IF PRODUCT IS NOT A BOOK");
                    System.out.print("\nChoose Size & Color");
                ...
                } else if (action.equalsIgnoreCase("PRINTCART")) //Prints items in the cart
                {
                    String customerId = "";
                    ...
                    System.out.println();
                } else if (action.equalsIgnoreCase("ORDERITEMS")) //Order items
                {
                    String customerId = "";
                ...
                System.out.print("\n>");
            }catch (customerNotFoundMessage | invalidCustomerAddressMessage | invalidCustomerNameMessage | productNotFoundMessage | invalidProductOptionsMessage | productOutOfStockMessage | orderNotFoundMessage e) //Exceptionhandler
            {
